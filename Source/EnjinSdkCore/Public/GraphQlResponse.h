 ...
 */
template <class ...>
class ENJINSDKCORE_API TGraphQlResponse;
 ...
 */
template <class T>
class ENJINSDKCORE_API TGraphQlResponse<T> final : public IGraphQlResponse
{
 ...
 */
template <class T>
class ENJINSDKCORE_API TGraphQlResponse<TArray<T>> final : public IGraphQlResponse
{
