 ...
 */
class ENJINSDKCORE_API FCreateAsset final : public GraphQl::IGraphQlRequest,
...
template ENJINSDKCORE_API FCreateAsset&
...
template ENJINSDKCORE_API Project::FCreateAsset&
