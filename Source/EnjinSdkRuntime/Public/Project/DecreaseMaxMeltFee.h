 ...
 */
class ENJINSDKRUNTIME_API FDecreaseMaxMeltFee final : public GraphQl::IGraphQlRequest,
...
template ENJINSDKRUNTIME_API FDecreaseMaxMeltFee&
...
template ENJINSDKRUNTIME_API Project::FDecreaseMaxMeltFee&
