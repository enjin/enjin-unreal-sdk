 ...
 */
ENJINSDKCORE_API EAssetTransferFeeType ToAssetTransferFeeType(const FString& String);
 ...
 */
ENJINSDKCORE_API const TCHAR* ToString(const EAssetTransferFeeType Value);
}
}
}
